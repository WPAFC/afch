...
function afcHelper_ffu_onActionChange(id) {
	...
	if (selectValue == 'none') extra.innerHTML = '';
		...
		'<div id="afcHelper_ffu_recenttextdiv_'+id+'"><label for="afcHelper_ffu_recenttext_' + id + '">File description for <a href="' + wgArticlePath.replace("$1", 'Wikipedia:Files for upload/recent') + '" title="Wikipedia:Files for upload/recent" target="_blank">Wikipedia:Files for upload/recent</a>: </label><input type="text" id="afcHelper_ffu_recenttext_' + id + '" name="afcHelper_ffu_recenttext_' + id + '"/></div>' +
